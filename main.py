...
from switch_widget import PySwitch, PyPushButton
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow: QtWidgets.QMainWindow):
        ...
        MainWindow.setWindowFlags(
            QtGui.Qt.FramelessWindowHint | QtGui.Qt.WindowStaysOnTopHint
        )
        ...
        self.pushButton = PySwitch(self.centralwidget)
    ...
    def mouseMoveEvent(self, event: QtGui.QMouseEvent):
        ...
        self.MainWindow.move(
            self.MainWindow.x() + delta.x(), self.MainWindow.y() + delta.y()
        )
        self.oldPos = event.globalPosition().toPoint()
